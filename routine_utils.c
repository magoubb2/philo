...
// This function prints the messages we want to 
// print and the current time - start_timer.
...
// This function is used for the enum to print 
// the message in the print_message function.
