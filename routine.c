...
/*   Updated: 2023/10/02 17:06:53 by mabaron-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philo.h"

// This function prints the message for when a philo is 
// taking a left frok, a right fork and when it's eating.
...
// This function prints the message for when a philo is sleeping 
// and it sleeps for the length of time we ask it to sleep.
...
// Philo's routine, if there is a 5th argument, once the 
// nb_of_meals is == to the number of max_eat, the program
// breaks and stops.
